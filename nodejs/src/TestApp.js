...
export default function TestApp() {
    ...
    const [appbackColor, setAppBackColor] = useState(' ');
    ...
    return (
        <div className={styles.app} style={{backgroundColor: appbackColor}}>
            <div className={styles.themeSlider} >
                <label className={styles.switch} >
                    ...
                    <input type="checkbox" className={styles.input} id='themeInput' onClick={handleChangeTheme} checked={isChecked}/>
